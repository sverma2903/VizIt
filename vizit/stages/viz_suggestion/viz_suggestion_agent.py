...
def create_viz_suggestion_agent() -> NormalAgent:
    ...
    agent = NormalAgent(
        ...
        description=textwrap.dedent("""
            ...
            Given a summary of the DataFrame and some more information about it, current local variables context, along with some statistics and insights from it, propose handful of meaningful charts or plots
